...
/**
  ...
  * @retval None
  */
 #define USART_REC_LEN  			100  //最大接收字节 	
...
extern int MODE1[5];
extern int MODE2[5];
extern int CHX_3,MAXoutput_Voltage[5],Maxoutput_re;
extern int MODE4[5];
extern int MODE5[5];
extern int MODE6[5];
extern int input_state[5];
extern int IO_output_state[5];
extern int IP[8];
extern int Mask[8];
extern int Gateway[8];
extern int Remote_IP[8];
extern int Tcp_IP[5];
extern int Remote_TcpIP[5];
extern int Version[5];
u8 RST_flag=0;
extern int wei;
